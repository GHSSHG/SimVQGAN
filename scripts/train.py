...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--val-batches", type=int, default=2, help="Number of batches per validation run")
...
def main() -> None:
    ...
    if args.config is not None:
        ...
        val_spec = _merge_split_cfg(base_data_cfg, data_cfg.get("validation")) if data_cfg.get("validation") else None
